...
import { Brain, Zap, Eye, Shield, Target, Code, ChevronDown, Globe, Download, Star, Check, Book, Lock, Search, Mail, Phone, MapPin, FileText, Scale, Users, Calendar, Clock, Award, Building } from 'lucide-react';
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <section id="legal" className="py-20 px-4 bg-gray-800/30">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-4xl font-bold text-green-400 mb-12 text-center">
          ...
          <Card className="bg-gray-800 border-green-400/20">
            <CardContent className="p-8">
              <div className="space-y-8">
                <section>
                  <h4 className="text-2xl font-semibold text-green-400 mb-6">Company Information</h4>
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-6">
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <h5 className="font-semibold text-white mb-2">Business Owner</h5>
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <h5 className="font-semibold text-white mb-2">Full Address</h5>
                          <p className="text-gray-300">
                            Aimad Djeddi<br />
                ...
                <section>
                  <h4 className="text-2xl font-semibold text-green-400 mb-4">Payment Processing</h4>
                  <div className="bg-gray-700 p-6 rounded-lg space-y-3">
                    ...
                    <p className="text-gray-300">
                      The debit is made by Digistore24 GmbH (Germany), and the withdrawal from your account will be executed by Digistore24.
                    </p>
                    <p className="text-gray-300">
                ...
                <section>
                  <h4 className="text-2xl font-semibold text-green-400 mb-4">Product Information</h4>
                  <div className="bg-gray-700 p-6 rounded-lg space-y-3">
                    <p className="text-gray-300">
                ...
                <section>
                  <h4 className="text-2xl font-semibold text-green-400 mb-4">Refund Guarantee</h4>
